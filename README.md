> This plugin has been deprecated (since v9), and its functionality (without the GUI support) has been incorporated into the [core FMTC](https://github.com/JaffaKetchup/flutter_map_tile_caching) package.
